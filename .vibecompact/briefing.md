...
Anchor: `a286bf23af69` (2026-08-19). Generated with the audit report; findings below are corroborated by ≥2 independent lanes unless marked otherwise.
...
- Trust note: the arrival lane is repo-saturated (82% firing) and muted from corroboration this run.
...
- `worker/src/routes/jobs/state.ts` — duplication: 42 duplicated lines across 1 partner(s) → `.vibecompact/findings/worker__src__routes__jobs__state.ts.md`
- `worker/src/routes/jobs/feedback.ts` — duplication: 40 duplicated lines across 1 partner(s) → `.vibecompact/findings/worker__src__routes__jobs__feedback.ts.md`
